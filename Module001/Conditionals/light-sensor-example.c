...
/* program to take several readings of the Scribbler 2 light sensors
   ...
   compile this program with the line
     ...
     gcc -lbluetooth -lMyroC -o light-sensor-example light-sensor-example.c
*/
...
int main ()
{
  ...
  /* get light in front and to the right */
  int front = rGetLightTxt("center", 3); /* average 3 readings */
  int right = rGetLightTxt("right", 3);
